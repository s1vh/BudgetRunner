...
export function TransactionList({ transactions, categories = [], limit, onSelect, timeZone }: { transactions: FinancialTransaction[]; categories?: Category[]; limit?: number; onSelect?: (transaction: FinancialTransaction) => void; timeZone?: string }) {
  const { t, td } = useI18n()
